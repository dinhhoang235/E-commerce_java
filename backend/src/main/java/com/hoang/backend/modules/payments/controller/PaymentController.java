...
import com.hoang.backend.modules.payments.service.PaymentCommandService;
import com.hoang.backend.modules.payments.service.PaymentQueryService;
import com.hoang.backend.modules.payments.service.StripeWebhookHandler;
...
public class PaymentController {
    ...
    public ResponseEntity<PaymentSessionResponse> createCheckoutSession(
        ...
        return ResponseEntity.ok(paymentCommandService.createCheckoutSession(authentication.getName(), request.order_id()));
    }
    ...
    public ResponseEntity<PaymentSessionResponse> createCheckoutSessionFromCart(
        ...
        return ResponseEntity.ok(paymentCommandService.createCheckoutSessionFromCart(authentication.getName(), request));
    }
    ...
    public ResponseEntity<PaymentSessionResponse> continuePayment(
        ...
        return ResponseEntity.ok(paymentCommandService.continuePayment(authentication.getName(), request.order_id()));
    }
    ...
    public ResponseEntity<Map<String, Object>> verifyPayment(
        ...
        return ResponseEntity.ok(paymentCommandService.verifyPaymentAndCreateOrder(authentication.getName(), request.session_id()));
    }
    ...
    public ResponseEntity<Map<String, Object>> paymentStatus(Authentication authentication, @PathVariable String orderId) {
        return ResponseEntity.ok(paymentQueryService.paymentStatus(authentication.getName(), orderId));
    }
    ...
    public ResponseEntity<Map<String, Object>> refund(Authentication authentication, @RequestBody RefundRequest request) {
        return ResponseEntity.ok(paymentCommandService.processFullRefund(authentication.getName(), request.order_id(), request.reason()));
    }
    ...
    public ResponseEntity<Map<String, Object>> refundStatus(Authentication authentication, @PathVariable String orderId) {
        return ResponseEntity.ok(paymentQueryService.refundStatus(authentication.getName(), orderId));
    }
    ...
    public ResponseEntity<Map<String, Object>> validateCartVariants(@RequestBody CreateCheckoutFromCartRequest request) {
        return ResponseEntity.ok(paymentCommandService.validateCartVariants(request == null ? null : request.cart_items()));
    }
    ...
    public ResponseEntity<Void> webhook(
        ...
        stripeWebhookHandler.handleEvent(payload);
